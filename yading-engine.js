...
(function (global) {
  ...
  /* 免票预约（★ 2026-09-22 最新核实更新，来源：景区管理局官方公告 + 新浪旅游 09-21） */
  ticket: {
    freePeriod: '2026-08-01 至 10-31，全国游客景区大门票全免（原价 146 元，管理局 7/10 公告）；应届中高考生凭准考证+身份证，每年 6/10-8/31 不限次免票',
    shuttleNote: '★ 最新（2026-09-22 多源核实）：观光车（原价120）+电瓶车（原价80）自 5/29 起暂停收费，目前免费乘坐（文旅部整改期间）；8/1-10/31 叠加大门票免票（原价146），单人景区刚性支出为 0 元。成本监审完成后将重新核定正式价格，建议出发前确认最新政策；官方电话 0836-6966022',
    releaseTime: '每日 07:00 放票（多源确认，含景区官方小程序）；热门日期放票后 1-2 小时内约满，需闹钟卡点；OTA 另有每日 0 点放票说法，建议双保险',
    window: '预约提前期主流为 15 天；OTA 多为 10 天，且历史上曾仅提前 1 天，后放宽至 15 天。实操建议：按 15 天设首个闹钟抢票，若当天未开放则第 14/10 天再各试一次',
    dailyLimit: '最大承载量 15,000 人/日，约满即关闭预约渠道；国庆（10/1-7）名额极度紧张，需提前 7-15 天抢',
    channel: '「稻城亚丁」微信小程序（优先：放票最早、余量最准、退改最直接）/ 携程/美团/飞猪/去哪儿等 OTA。官方约满时可去 OTA 捡漏；不要多平台重复预约以免被判异常',
    entry: '身份证原件刷证，人证票合一；现场窗口已于 2026-01-01 起全面取消售票（仅取票和咨询，外宾持护照到线下窗口）；儿童也须实名预约',
    hours: '游客中心服务 7:00-16:40（16:40 停止检票）；金刚挑战线（长线）8:00-14:30 开放，14:30 后禁止进入；观光车上山 7:10-17:00、下山末班 19:00；电瓶车 8:00-16:30；建议入园最佳时段 7:00-8:30',
    fireSeason: '防火期 10/1 - 次年 6/30，严禁携带火源（打火机、火柴等）',
    banned: '无人机、宠物禁入；景区全域禁飞无人机；牛奶海/五色海/卡斯区域封闭管理；景区内禁止非酒店区域留宿及野外露营',
    refund: '游览日前 24h 以上免费退订；24h 内收 4%；过期未入园收 10%；需在原预约渠道操作',
    reentry: '二次进沟：首日入园后第二天凭身份证可再次入园（需重新预约当日名额）；长线+短线分两天走更稳妥，注意观光车运营时间',
    costSummary: '国庆期间单人景区刚性支出：0 元（门票 0 + 观光车 0 + 电瓶车 0，5/29 起暂停收费，持续至价格重新核定）；骑马等自愿消费另计',
  ...
  legalRisk: {
    ...
    reality: '★ 重要更新（2026-09）：稻城县政府联合亚管局、香格里拉镇政府、派出所已建立常态化联合执法机制，在景区边界、未开放区域入口、高危路段增设高清监控+红外感应设备，对洛克线等非法穿越高发路线针对性布防，跨区域联合木里县从源头阻断非法进入通道。执法明显比往年更系统、更严密。9 月已有俱乐部团期被劝返的记录',
    advice: [
  ...
  transport: {
    ...
    roadWorks: [
      '★ G318 雅江段（剪子弯山隧道养护站 K3017 → 红龙镇东来一村 K3070+210，全长 53.21km）：2026-10-09 至 10-26，每日 8:00-12:00、14:00-18:00 半幅单边交替放行，放行间隔约 30 分钟。→ 进山 10/4 不受影响；出山返程 10/10 撞管制，务必预留 1-3 小时堵车余量或错开管制时段',
      '★ G318 理塘段（禾尼乡金厂沟—大毛垭坝 K3146-K3148）：2026-09-22 至 09-23，每日 8:00-12:00、14:00-18:00 半幅交替放行 → 进山 10/3-4 不受影响（10/4 进山走该段需注意）',
      'G318 康定段（呷巴乡—新都桥 K2899-K2902）：2026-10-28 至 10-30 施工（国庆返程不受影响）',
      'G227 理塘君坝镇段（K1700-K1737）：2026-09-08 至 09-21 → ★ 已于 9/21 到期解除，不再影响行程',
      'G227 新龙段（K1515-K1568）：2026-09-01 至 10-31 半幅交替放行（节假日不管制；不影响稻城方向主干道）',
      'G318 天全喇叭河段（K2726+700-G2726+900）：2026-07-27 至 09-24 单边交替放行（9/24 后解除）',
      'G227 甘孜县下雄洛戈段（K1487-K1489）：2026-10-18 至 10-19 全幅封闭（不在稻城方向主干道）',
    ],
  ...
  /* 住宿（★ 2026-09-22 最新数据：携程/同程/新浪 09-09 核实） */
  hotels: {
    '香格里拉镇': {
      alt: '2900m',
      low: '床位 80-100 / 标间 200-300',
      holiday: '标间 600-1200（国庆极端时段同酒店可从 249 涨至 1600+）',
      dist: '距景区 1-2.5km',
      rec: '首选（低海拔适应）',
      tips: '国庆期间务必提前 15-30 天预订，多平台比价（美团/携程/去哪儿差价可达 50 元/晚），选可免费取消房型；推荐供氧型酒店（淡季约 280 元/晚，旺季约 500+）'
    },
    '亚丁村': {
      alt: '4060m',
      low: '床位 100-150 / 标间 400',
      holiday: '标间 800-1200（国庆极端时段）',
      dist: '景区内',
      rec: '高反风险大，仅推荐有高原经验者',
      tips: '推窗即见神山，可省二次进沟观光车费 120 元/人，清晨拍日照金山优势明显；海拔 4060m 需严格防范高反'
    },
    '稻城县城': {
      alt: '3750m',
      low: '标间约 150',
      holiday: '标间 400-500',
      dist: '距景区 70-80km（车程约 1.5h）',
      rec: '自驾/穷游备选，不推荐首晚住宿（距景区远、且海拔仍高）',
      tips: '沿途可看海子山/红草地，价格最低但需次日 6 点前出发'
    },
  },
